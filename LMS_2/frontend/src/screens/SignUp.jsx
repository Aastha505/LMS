        ...
        <div className='bg-[#F4F5FA] h-screen flex justify-center items-center '>
            <div className="px-[34px] py-[44px] w-fit bg-white flex flex-col justify-center rounded-[12px]">
                ...
                <div className='flex flex-row gap-[20px]'>
                    <div>
                        <input onChange={(e) => setRole(e.target.value)} value={"institute"} type="radio" name="role" />
                ...
                <div className='flex justify-center'>
                    <button onClick={handleSignUp} className='px-[16px] py-[17px] w-[148px] bg-[#5570F1] text-white font-[inter] text-[20px] rounded-[12px]' >Sign Up</button>
                </div>
            </div>
        </div>
    )
